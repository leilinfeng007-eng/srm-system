...
public class ParameterController {
    ...
    @PutMapping("/{id}") @PreAuthorize("hasAuthority('system:parameter:update')") public ApiResponse<Void> update(@PathVariable Long id,@RequestBody ParameterRequest b) { r.updateParameter(id,b.paramName(),b.paramType(),b.defaultValue(),b.validationRule(),b.approvalRequired(),b.description()); return ApiResponse.success(); }
